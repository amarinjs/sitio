...
Note on the linux terminals, how the data is being polled at the given rate. On the cisco router, conformed and exceeded traffic isss being accounted for.
